...
export class Sidebar extends React.Component {
  ...
  state = {
    navItems: [
      ...
      { pathname: '/paciente', label: 'Pacientes', icon: 'user' },
      { pathname: '/doctor', label: 'Doctores', icon: 'user-md' },
      { pathname: '/cambio', label: 'Cambio', icon: 'scissors' },
      {
        pathname: '/tratamiento',
        label: 'Tratamientos',
